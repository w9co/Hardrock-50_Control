...
##HRMX - last tx status - space delimited string pep watts, avg watts, swr, temp
...
def update_display(window):
    # make call to HRRX and HRMX to get updated display values.
    hrrx_res = get_hrrx()
    ...
    #update last tx info display
    window['last_txinfo'].update('Last TX: PEP {} | Avg {} | SWR {}'.format(
        hrmx_res[1][1:],
        hrmx_res[2][1:],
        hrmx_res[3][1:],
    ))
...
band_disp = [
    [sg.Text('', size=(5, 1), font='Any 60', key='band_display')],
]

temp_disp = [
    [sg.Text('', size=(4, 1), font='Any 20', key='temp_display')],
]

voltage_disp = [
    [sg.Text('', size=(6, 1), font='Any 20', key='voltage_display')],
]

keying_disp = [
    [sg.Text('', size=(3, 1), font='Any 10')],
]

txinfo = [
    [sg.Text('Loading...', size=(40, 1), font='Any 10', key='last_txinfo')],
]
...
while True:             # Event Loop
    ...
    try:
        ...
        window['last_txinfo'].update('ERROR: {}'.format(e))
